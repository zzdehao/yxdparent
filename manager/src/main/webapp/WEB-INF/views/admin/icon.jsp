...
<link rel="stylesheet" href="lib/Hui-iconfont/1.0.1/iconfont.css">
<style type="text/css">
...
.icon_lists .Hui-iconfont:hover { font-size: 100px ; border:solid 2px #ccc;cursor: pointer; }
</style>
</head>
<body>
<div class="main">
...
$(function(){
	$(".icon_lists li i").bind("click",function(){
		var index = parent.layer.getFrameIndex(window.name);
		var icon = "Hui-iconfont "+$(this).parent().find("div").eq(2).html().substr(1) ;
		parent.$(".show_iframe:visible > iframe").contents().find("#icon").val(icon);
